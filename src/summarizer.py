...
class SummaryGenerator:
    ...
    def generate_csv(self, aggregated_data: Dict[Tuple[str, str, str, str, int], Dict[str, Any]]) -> Path:
        """
        ...
        for key, metrics in aggregated_data.items():
            ...
            row = {
                ...
                'dataset_record_count_latest': metrics.get('dataset_record_count_latest', 0),
                'filtered_record_count_latest': metrics.get('filtered_record_count_latest', 0),
    ...
    def generate_nl_sentences(self, aggregated_data: Dict[Tuple[str, str, str, str, int], Dict[str, Any]]) -> Path:
        """
        ...
        try:
            ...
            logger.info(f"Generated NL sentences: {nl_path} ({len(sentences)} sentences)")
            return nl_path
        except Exception as e:
...
def generate_full_summary_csv(aggregated_data: Dict[Tuple[str, str, str, str, int], Dict[str, Any]], 
                             output_dir: str) -> Path:
    """
...
def generate_nl_sentences(aggregated_data: Dict[Tuple[str, str, str, str, int], Dict[str, Any]], 
                         output_dir: str) -> Path:
    """
